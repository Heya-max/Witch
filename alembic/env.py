...
def run_migrations_offline() -> None:
    """Run migrations in 'offline' mode; render SQL instead of emitting it."""
...
async def _run_migrations_async(url: str) -> None:
...
def run_migrations_online() -> None:
    """Run migrations in 'online' mode, supporting asyncpg/aiosqlite URLs."""
    url = _database_url()

    if _is_async(url):
        import asyncio

        asyncio.run(_run_migrations_async(url))
        return
